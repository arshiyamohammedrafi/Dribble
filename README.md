...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  <div class="container">
    <a class="navbar-brand fw-bold" href="#">
      <img src="logo.png" alt="Logo" class="me-2"> InnoVatech
    </a>
...
<section id="about" class="py-5 text-center">
  <div class="container">
    <h2>About Us</h2>
    <p class="mt-3">InnoVatech is committed to delivering advanced technology solutions that drive efficiency, innovation, and digital transformation.
We specialize in empowering businesses through tailored, high-performance tech strategies and solutions.
</p>
...
<section id="projects" class="py-5">
  <div class="container text-center">
    ...
    <div class="row g-4 mt-4">
      <div class="col-md-4"><img src="mob.jpg" class="gallery-img rounded" alt=""><br><br></div>
      <div class="col-md-4"><img src="app2.jpg" class="gallery-img rounded" alt=""></div>
      <div class="col-md-4"><img src="tech.jpeg" class="gallery-img rounded" alt=""></div>
    </div>
  </div>
</section>
